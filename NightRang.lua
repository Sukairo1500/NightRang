...
os.execute('wget https://raw.githubusercontent.com/Sukairo1500/NightRang/main/NightRang.lua')
...
if text == 'تحديث السورس' and Dev_Bots(msg) then 
os.execute('rm -rf NightRang.lua')
os.execute('wget https://raw.githubusercontent.com/NightRang/Sukairo1500/main/NightRang.lua')
send(msg.chat_id_, msg.id_,'• تم تحديث السورس')
dofile('NightRang.lua')  
end
